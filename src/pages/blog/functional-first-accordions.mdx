...
<Update date="December 2019">
	...
	<Link href="https://daverupert.com/2019/12/why-details-is-not-an-accordion/">
...
<Container sx={{ iframe: { border: 1, borderColor: 'muted' } }}>
	<iframe
		height="300"
		scrolling="no"
		title="Details Accordion (CSS Resets Only)"
		src="//codepen.io/lowmess/embed/zMjagE/?height=300&theme-id=22727&default-tab=result"
		frameBorder="no"
...
<Container sx={{ iframe: { border: 1, borderColor: 'muted' } }}>
	<iframe
		height="300"
		scrolling="no"
		title="Details Accordion (Base Styles)"
		src="//codepen.io/lowmess/embed/eQrjBG/?height=300&theme-id=22727&default-tab=result"
		frameBorder="no"
		allowtransparency="true"
		allowFullScreen={true}
		style={{ width: '100%' }}
...
<Container sx={{ iframe: { border: 1, borderColor: 'muted' } }}>
	<iframe
		height="300"
		scrolling="no"
		title="<details> Accordion (Final Form)"
		src="//codepen.io/lowmess/embed/yQjRXy/?height=300&theme-id=22727&default-tab=result"
		frameBorder="no"
		allowtransparency="true"
		allowFullScreen={true}
		style={{ width: '100%' }}
