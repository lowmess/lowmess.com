...
<Update date="October 2020">
  A mere [checks notes] week after I initially made this migration, I{' '}
  <em>did</em> wind up switching the way the homepage fetches the stat
  data. It's not quite fully server-rendered, however; I'm using something
  Next.js calls{' '}
